// server.js – Breezeline Interiors (With Classic Standard Email Templates)
...
// Database connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/breezeline')
...
app.use(session({
  ...
  store: MongoStore.create({
    mongoUrl: process.env.MONGODB_URI || 'mongodb://localhost:27017/breezline'
  }),
...
app.listen(PORT, async () => {
  console.log('\n🚀 Breezeline Interiors Server Starting...');
  ...
  console.log(`🔗 Work Gallery: http://localhost:${PORT}/project.html`);
  console.log(`🔗 Admin: http://localhost:${PORT}/admin-login.html`);
  console.log('\n📊 Classic Email System Active:');
  console.log('   ✅ User receives professional estimation confirmation');
  console.log('   ✅ Admin receives detailed lead notification');
  console.log('   ✅ Classic standard email templates for both');
});